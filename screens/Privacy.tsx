  ...
  return (
    ...
    >
      ...
      <Text style={styles.text}>
        ...
        the Fake Account. The use of the Internet pages of the Fake Account is
      ...
      <Text style={styles.text}>
        ...
        Fake Account. By means of this data protection declaration, our
      ...
      <Text style={styles.text}>
        As the controller, the Fake Account has implemented numerous technical
      ...
      <Text style={styles.title}>1. Definitions</Text>
      <Text style={styles.text}>
        The data protection declaration of the Fake Account is based on the
      ...
      <Text style={styles.subtitle}>b) Data subject</Text>
      <Text style={styles.text}>
        Data subject is any identified or identifiable natural person, whose
        personal data is processed by the controller responsible for the
        processing.
      </Text>
      <Text style={styles.subtitle}>c) Processing</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.subtitle}>f) Pseudonymisation</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.subtitle}>h) Processor</Text>
      <Text style={styles.text}>
        Processor is a natural or legal person, public authority, agency or
        other body which processes personal data on behalf of the controller.{" "}
      </Text>
      <Text style={styles.subtitle}>i) Recipient</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.subtitle}>j) Third party</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.subtitle}>k) Consent</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.title}>2. Name and Address of the controller</Text>
      <Text style={styles.text}>
        Controller for the purposes of the General Data Protection Regulation
        (GDPR), other data protection laws applicable in Member states of the
        European Union and other provisions related to data protection is:
      </Text>
      <Text style={styles.text}>Kay Vieider</Text>
      <Text style={styles.text}>39053 Steinegg</Text>
      <Text style={styles.text}>Italien</Text>
      <Text style={styles.text}>Email: kayvieider97@gmail.com</Text>
      <Text style={styles.title}>3. Cookies</Text>
      <Text style={styles.text}>
        The Internet pages of the Fake Account use cookies. Cookies are text
      ...
      <Text style={styles.text}>
        Through the use of cookies, the Fake Account can provide the users of
      ...
      <Text style={styles.text}>
        The website of the Fake Account collects a series of general data and
      ...
      <Text style={styles.text}>
        When using these general data and information, the Fake Account does not
        ...
        cyber-attack. Therefore, the Fake Account analyzes anonymously collected
      ...
      <Text style={styles.title}>6. Rights of the data subject</Text>
      <Text style={styles.subtitle}>a) Right of confirmation</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.subtitle}>b) Right of access</Text>
      <Text style={styles.text}>
        Each data subject shall have the right granted by the European
      ...
      <Text style={styles.subtitle}>c) Right to rectification </Text>
      <Text style={styles.text}>
        Each data subject shall have the right granted by the European
      ...
      <Text style={styles.text}>
        ...
        to request the erasure of personal data stored by the Fake Account, he
        or she may, at any time, contact any employee of the controller. An
        employee of Fake Account shall promptly ensure that the erasure request
      ...
      <Text style={styles.text}>
        ...
        required. An employees of the Fake Account will arrange the necessary
        measures in individual cases.
      </Text>
      <Text style={styles.subtitle}>e) Right of restriction of processing</Text>
      <Text style={styles.text}>
        Each data subject shall have the right granted by the European
      ...
      <Text style={styles.text}>
        ...
        stored by the Fake Account, he or she may at any time contact any
        employee of the controller. The employee of the Fake Account will
        arrange the restriction of the processing.{" "}
      </Text>
      <Text style={styles.subtitle}>f) Right to data portability</Text>
      <Text style={styles.text}>
        Each data subject shall have the right granted by the European
      ...
      <Text style={styles.text}>
        ...
        at any time contact any employee of the Fake Account.
      </Text>
      <Text style={styles.subtitle}>g) Right to object</Text>
      <Text style={styles.text}>
        Each data subject shall have the right granted by the European
      ...
      <Text style={styles.text}>
        The Fake Account shall no longer process the personal data in the event
      ...
      <Text style={styles.text}>
        If the Fake Account processes personal data for direct marketing
        ...
        direct marketing. If the data subject objects to the Fake Account to the
        processing for direct marketing purposes, the Fake Account will no
      ...
      <Text style={styles.text}>
        ...
        concerning him or her by the Fake Account for scientific or historical
      ...
      <Text style={styles.text}>
        ...
        any employee of the Fake Account. In addition, the data subject is free
      ...
      <Text style={styles.text}>
        ...
        is based on the data subject's explicit consent, the Fake Account shall
      ...
      <Text style={styles.text}>
        ...
        consent, he or she may, at any time, contact any employee of the Fake
        Account.
      </Text>
      <Text style={styles.title}>
      ...
      <Text style={styles.title}>10. Legal basis for the processing </Text>
      <Text style={styles.text}>
